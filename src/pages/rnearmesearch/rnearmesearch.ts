...
/**
 * Generated class for the RnearmesearchPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-rnearmesearch',
  templateUrl: 'rnearmesearch.html',
})
export class RnearmesearchPage {
restaurantsArray = [];
restaurants;
randomRestaurant;
...
loader.present().then(() => {
	...
	this.rnearmeProv.lat = resp.coords.latitude
 	...
 	this.rnearmeProv.getAllcustom().subscribe(data=> {
